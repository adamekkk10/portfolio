...
/** Obsah hero sekce najíždí postupně hned po načtení, ne až na scroll. */
    ...
    <section className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-6 pt-10 pb-20 sm:pt-14 sm:pb-28">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="mx-auto mt-14 flex max-w-3xl flex-col items-center text-center sm:mt-20"
        >
          {/* Pre-headline */}
          <motion.p
            data-reveal=""
            variants={item}
            className="inline-flex items-center rounded-full border border-border bg-white/60 px-3.5 py-1.5 text-xs font-medium text-muted-foreground shadow-sm backdrop-blur-sm sm:text-[0.8125rem]"
          >
          ...
          <motion.h1
            data-reveal=""
            variants={item}
            className="mt-6 text-4xl font-semibold tracking-[-0.02em] text-balance sm:text-5xl lg:text-6xl lg:leading-[1.08]"
          >
          ...
          <motion.p
            data-reveal=""
            variants={item}
            className="mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground text-pretty sm:mt-8 sm:text-lg"
          >
          ...
          >
            ...
            >
              <a href="#formular">
                ...
                <ArrowRight
                  className="hidden size-[1.125rem] transition-transform group-hover/button:translate-x-0.5 sm:block"
                  aria-hidden="true"
                />
              </a>
            </Button>
          ...
          <motion.p
            data-reveal=""
            variants={item}
            className="mt-5 flex items-center justify-center gap-1.5 text-[0.8125rem] text-muted-foreground sm:text-sm"
          >
